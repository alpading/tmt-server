...
CREATE TABLE "theme_mappings" (
  ...
  CONSTRAINT "FK_theme_mappings_theme_id"      FOREIGN KEY ("theme_id")      REFERENCES "theme"("id"),
  CONSTRAINT "FK_theme_mappings_preference_id" FOREIGN KEY ("preference_id") REFERENCES "preferences"("id")
);

-- 취향 설문 질문 (TravelTest 페이지용)
...
CREATE TABLE "courses" (
  ...
  CONSTRAINT "FK_courses_theme_id" FOREIGN KEY ("theme_id") REFERENCES "theme"("id")
);
...
CREATE TABLE "course_stays" (
  ...
  CONSTRAINT "FK_course_stays_course_id"              FOREIGN KEY ("course_id") REFERENCES "courses"("id"),
...
CREATE TABLE "course_activities" (
  ...
  CONSTRAINT "FK_course_activities_course_id"             FOREIGN KEY ("course_id")   REFERENCES "courses"("id"),
...
CREATE TABLE "course_restaurants" (
  ...
  CONSTRAINT "FK_course_restaurants_course_id"                FOREIGN KEY ("course_id")     REFERENCES "courses"("id"),
  CONSTRAINT "FK_course_restaurants_restaurant_id"            FOREIGN KEY ("restaurant_id") REFERENCES "restaurants"("id")
);

-- course_items: 코스 아이템 통합 테이블 (중간 설계안에서 생성, 현재 미사용)
